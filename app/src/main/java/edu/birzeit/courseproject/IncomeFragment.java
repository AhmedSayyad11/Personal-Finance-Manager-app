...
public class IncomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Spinner spCat = view.findViewById(R.id.spCategoryIncome);
        ...
        Button btnAdd = view.findViewById(R.id.btnAddIncome);
        ListView listView = view.findViewById(R.id.listIncome);
        ...
        cats = catRepo.getCategories(email, "INCOME");
        ...
        list = repo.getTransactionsSortedByDate(email, "INCOME");
        ...
        btnAdd.setOnClickListener(v -> {
            ...
            repo.addTransaction(email, "INCOME", cat, amt, desc, selectedDate);
    ...
    private void refresh(String email) {
        list.clear();
        list.addAll(repo.getTransactionsSortedByDate(email, "INCOME"));
